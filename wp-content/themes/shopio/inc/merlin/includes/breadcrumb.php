...
class Shopio_breadcrumb {
	...
	private function __construct() {
		...
		add_filter('shopio_page_title', [$this, 'hide_title']);
	...
	public function breadcrumb_register() {
		$labels = [
			'name'               => esc_html__('Breadcrumbs', 'shopio'),
			'singular_name'      => esc_html__('Breadcrumb', 'shopio'),
			'menu_name'          => esc_html__('Breadcrumbs', 'shopio'),
			'name_admin_bar'     => esc_html__('Breadcrumb', 'shopio'),
			'add_new'            => esc_html__('Add New', 'shopio'),
			'add_new_item'       => esc_html__('Add New Breadcrumb', 'shopio'),
			'new_item'           => esc_html__('New Header Footer & Blocks Template', 'shopio'),
			'edit_item'          => esc_html__('Edit Header Footer & Blocks Template', 'shopio'),
			'view_item'          => esc_html__('View Header Footer & Blocks Template', 'shopio'),
			'all_items'          => esc_html__('All Breadcrumb', 'shopio'),
			'search_items'       => esc_html__('Search Header Footer & Blocks Templates', 'shopio'),
			'parent_item_colon'  => esc_html__('Parent Header Footer & Blocks Templates:', 'shopio'),
			'not_found'          => esc_html__('No Header Footer & Blocks Templates found.', 'shopio'),
			'not_found_in_trash' => esc_html__('No Header Footer & Blocks Templates found in Trash.', 'shopio'),
		];
		...
		register_post_type('shopio-breadcrumb', $args);
	}
	...
	public function register_admin_menu() {
		add_submenu_page(
			'themes.php',
			esc_html__('Breadcrumbs', 'shopio'),
			esc_html__('Breadcrumbs', 'shopio'),
			'edit_pages',
			'edit.php?post_type=shopio-breadcrumb'
		);
	}
	...
	function ehf_register_metabox() {
		add_meta_box(
			'ehf-meta-box',
			esc_html__('Breadcrumb Options', 'shopio'),
			[
				$this,
				'efh_metabox_render',
			],
		...
		<table class="hfe-options-table widefat">
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('Display On', 'shopio'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
					   title="<?php echo esc_attr__('Add locations for where this template should appear.', 'shopio'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					...
					HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
						...
						[
							'title'          => esc_html__('Display Rules', 'shopio'),
							'value'          => '[{"type":"basic-global","specific":null}]',
							'tags'           => 'site,enable,target,pages',
							'rule_type'      => 'display',
							'add_rule_label' => esc_html__('Add Display Rule', 'shopio'),
						],
						$include_locations
					);
					?>
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('Do Not Display On', 'shopio'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
					   title="<?php echo esc_attr__('Add locations for where this template should not appear.', 'shopio'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					<?php
					HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
						...
						[
							'title'          => esc_html__('Exclude On', 'shopio'),
							'value'          => '[]',
							'tags'           => 'site,enable,target,pages',
							'add_rule_label' => esc_html__('Add Exclusion Rule', 'shopio'),
							'rule_type'      => 'exclude',
						],
						$exclude_locations
					);
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('User Roles', 'shopio'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help" title="<?php echo esc_attr__('Display custom template based on user role.', 'shopio'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					<?php
					HFE\Lib\Astra_Target_Rules_Fields::target_user_role_settings_field(
						...
						[
							'title'          => esc_html__('Users', 'shopio'),
							'value'          => '[]',
							'tags'           => 'site,enable,target,pages',
							'add_rule_label' => esc_html__('Add User Rule', 'shopio'),
						],
						$users
					);
					?>
	...
	public static function get_template_id() {
		...
		$hfe_templates = Astra_Target_Rules_Fields::get_instance()->get_posts_by_conditions('shopio-breadcrumb', $option);
	...
	public function block_template_frontend() {
		if (is_singular('shopio-breadcrumb') && !current_user_can('edit_posts')) {
	...
	function load_canvas_template($single_template) {
		...
		if ('shopio-breadcrumb' == $post->post_type) {
