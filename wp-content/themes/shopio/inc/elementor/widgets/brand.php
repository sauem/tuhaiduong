 ...
 * @since 1.0.0
 */
class Shopio_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Brands', 'shopio');
    }
    ...
    public function get_script_depends() {
        return ['shopio-elementor-brand', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'shopio'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'shopio'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'shopio'),
                'placeholder' => esc_html__('Brand Name', 'shopio'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_responsive_control(
            'brand_source',
            [
                'label'   => esc_html__('Brand Source', 'shopio'),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'default' => 'image',
                'options' => [
                    'image' => esc_html__('Image', 'shopio'),
                    'icon'  => esc_html__('Icon', 'shopio')
                ],
            ]
        );
        ...
        $this->add_control(
            'heading_settings',
            [
                'label'     => esc_html__('Settings', 'shopio'),
        ...
        $this->start_controls_section(
            'style_brand_wrapper',
            [
                'label' => esc_html__('Brand Item', 'shopio'),
                        ...
                        <div <?php echo shopio_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . shopio_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
...
$widgets_manager->register(new Shopio_Elementor_Brand());
