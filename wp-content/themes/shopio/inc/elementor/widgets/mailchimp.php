...
if (!shopio_is_mailchimp_activated()) {
    return;
}
...
class Shopio_Elementor_Mailchimp extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'shopio-mailchmip';
    }

    public function get_title()
    {
        return esc_html__('MailChimp Sign-Up Form', 'shopio');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Placeholder', 'shopio'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Border Color hover', 'shopio'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Shopio_Elementor_Mailchimp());
