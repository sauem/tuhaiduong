...
class Shopio_Elementor_Account extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'shopio-account';
    }

    public function get_title()
    {
        return esc_html__('Shopio Account', 'shopio');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'name_text_color',
            [
                'label' => esc_html__('Color Content', 'shopio'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
...
$widgets_manager->register(new Shopio_Elementor_Account());
