 ...
 * @since 1.0.0
 */
class Shopio_Elementor_Language_Switcher extends Elementor\Widget_Base
{
    ...
    {
        return 'shopio-language-switcher';
    }
    ...
    {
        return esc_html__('Language Switcher', 'shopio');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'typography',
                'selector' => '{{WRAPPER}} .shopio-language-switcher span.title',
            ]
        );
        ...
        $this->add_control(
            'label_color',
            [
                'label' => esc_html__('Label Color', 'shopio'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .shopio-language-switcher .item > div i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hover_right',
            [
                'label' => esc_html__('Hover Right', 'shopio'),
        ...
        $this->add_control(
            'hide_title',
            [
                'label' => esc_html__('Hide Title', 'shopio'),
                'type' => Controls_Manager::SWITCHER,
                'prefix_class' => 'language-switcher-style-hide-title-',
            ]
        );
    ...
    {
        shopio_language_switcher();
    }
}

$widgets_manager->register(new Shopio_Elementor_Language_Switcher());
