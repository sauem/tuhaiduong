...
class Shopio_Elementor_Vertiacl_Menu extends Elementor\Widget_Base
{
    ...
    {
        return 'shopio-vertical-menu';
    }

    public function get_title()
    {
        return esc_html__('Shopio Vertical Menu', 'shopio');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'nav_vertiacl_layout',
            [
                'label' => esc_html__('Menu Layout', 'shopio'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'style-1' => esc_html__('Dropdown', 'shopio'),
                    'style-2' => esc_html__('Navbar', 'shopio'),
                ],
                'default' => 'style-1',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation .vertical-navigation-header .shopio-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Icon Hover', 'shopio'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation:hover .vertical-navigation-header .shopio-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control('vertical_menu_separator', [
            'label' => esc_html__('Separator', 'shopio'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'shopio'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Active', 'shopio'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Color Hover', 'shopio'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render()
    {
        ...
        <div <?php echo shopio_elementor_get_render_attribute_string('wrapper', $this); ?>>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'shopio'); ?>">
...
$widgets_manager->register(new Shopio_Elementor_Vertiacl_Menu());
