 ...
 * @since 1.0.0
 */
class Shopio_Elementor_Widget_Products extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Products', 'shopio');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'ids'          => esc_html__('Product Name', 'shopio'),
                ],
            ]
        );
        ...
        $this->add_control(
            'product_ids',
            [
                'label'       => esc_html__('Products name', 'shopio'),
                'type'        => 'products',
                'label_block' => true,
                'multiple'    => true,
                'condition'   => [
        ...
        $this->add_control(
            'paginate',
            [
                'label'   => esc_html__('Paginate', 'shopio'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'none'       => esc_html__('None', 'shopio'),
                    'pagination' => esc_html__('Pagination', 'shopio'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   => [
                    ...
                    9      => esc_html__('Style 9', 'shopio'),
                    10     => esc_html__('Style 10', 'shopio'),
                    'deal' => esc_html__('Style Deal', 'shopio'),
                    'custom' => esc_html__('Custom', 'shopio'),
                    //====end_premium
                ],
                'condition' => [
                    'product_layout' => 'grid'
    ...
    protected function add_control_carousel($condition = array()) {
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Layout Carousel', 'shopio'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
        ...
        $this->add_control(
            'hover_style_arrow',
            [
                'label'        => esc_html__('Hover Arrow', 'shopio'),
                'type'         => Controls_Manager::SWITCHER,
...
$widgets_manager->register(new Shopio_Elementor_Widget_Products());
