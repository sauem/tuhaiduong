<?php
/**
 * Shopio_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Shopio_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Shopio_Product_Brand_List_Walker', false)) :

	class Shopio_Product_Brand_List_Walker extends Walker {
