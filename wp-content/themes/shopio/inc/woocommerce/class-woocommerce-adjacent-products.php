<?php
/**
 * Shopio WooCommerce Adjacent Products Class
 *
 * @package  shopio
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Shopio_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Shopio WooCommerce Adjacent Products Class
	 */
	class Shopio_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'shopio_woocommerce_adjacent_query_args', $args ) );
